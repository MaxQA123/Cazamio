...
{
    public class DBRequestApplicationOccupations
    {
        ...
        public class ApplicationOccupations
        {
            public static string DeleteRecordByApartmentApplicationId(long? apartmentApplicationId, string emailTenant, int marketplaceId)
            {
                ...
                {
                    SqlCommand command = new("DELETE FROM ApplicationOccupations WHERE ApartmentApplicationId = @ApartmentApplicationId AND TenantId" +
                               " IN" +
