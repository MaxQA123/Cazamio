...
namespace CazamioProject.DBHelpers.TableApartmentHistories
{
    public class DBRequestApartmentHistories
    {
        ...
        public class ApartmentHistories
        {
            public static string DeleteRecordByEmailMarketplaceId(int marketplaceId, string email)
            {
                ...
                {
                    SqlCommand command = new("DELETE FROM ApartmentHistories WHERE TenantId" + 
                               " IN" +
